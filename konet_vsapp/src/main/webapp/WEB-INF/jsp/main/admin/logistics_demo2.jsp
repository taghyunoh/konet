      ...
      <div class="g-sec">
        ...
        <table><tbody>
          <tr><td class="m">매입 등록 / 지급 등록</td><td>매입 전표와 <b>지급</b> 전표. 오른쪽에 그 거래처 원장이 함께 뜹니다.
            <div style="margin-top:4px;color:#5a6b7a"><b>· 이전 단가와 다르면 알려 줍니다</b>(2026-09-13) 상품을 담으면 그 거래처의 <b>지난 매입 단가</b>가 들어오고, 단가를 고쳐 지난 매입과 달라지면 단가 칸에 <b style="color:#c0392b">▲</b>(오름)·<b style="color:#1d4ed8">▼</b>(내림) 표시가 붙고(마우스를 올리면 이전 단가·그 날짜), 명세 밑에 <b>다른 줄만 모은 안내줄</b>이 뜹니다(누르면 그 줄로 갑니다). <b>매입분</b>으로 담은 줄은 목록 단가를 그대로 두고 다르면 표시만 합니다. <b>값은 바뀌지 않고 저장도 막지 않습니다</b> — 알리기만 합니다.</div></td></tr>
