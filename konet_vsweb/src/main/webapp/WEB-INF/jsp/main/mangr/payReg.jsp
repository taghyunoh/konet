  ...
  <div class="sv-card">
    ...
    <table class="sv-form">
      ...
      <tr>
        <th>거래처</th>
        <td>
          <input type="text" id="svCustNm" readonly placeholder="매입처를 선택하세요" style="width:230px">
...
var _list = [], _vendors = [], _cur = null, _curNet = 0;
...
function svBal(cd){
  if(!cd){ document.getElementById('svBal').textContent='0'; return; }
