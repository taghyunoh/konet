  ...
  <main class="logi-main">
    ...
    <section id="panel-guide" class="panel">
      ...
      <div class="g-sec">
        ...
        <table><tbody>
          <tr><td class="m">출고현황표(대시보드1/2)</td><td>발주현황표 엑셀 업로드 → 출고장·사업장·품목별 출고량 집계. 출고데이타 저장(TBL_SHIPOUT_MST). 매출마감의 원천.<br><b>※ 김해·제주는 조기출고</b> — 그 출고장 행의 <b>출고일자(SHPOUT_DT)= 납기일자 2일 전</b>으로 자동 저장됩니다(그 외 출고장은 미리보기에서 지정한 출고일자). 미리보기 하단(출고일자 좌측)에 안내 문구가 뜹니다.</td></tr>
