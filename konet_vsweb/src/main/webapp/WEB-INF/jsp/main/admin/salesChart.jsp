...
<div class="sc-wrap">
  ...
  <div class="sc-card">
    ...
    <div class="kpi">
      ...
      <div><span title="판매등록 전표 + 토더 발주(2026-09-22 토더 = 매출)">직접판매(전표·토더)</span><b id="kTrx">0</b></div>
  ...
  <div class="sc-card" id="scHelpBox" style="display:none; border-color:#9fcfc5; background:#f6fbfa">
    ...
    <div class="sc-note">
      ...
      &nbsp;&nbsp;· <b>직접판매(전표·토더)</b> — 판매등록으로 직접 입력한 매출 + 토더 발주(수량 × 토더 판매가, 부가세 포함 · 2026-09-22). 출고장별 그래프에서 토더는 「토더」 줄로 따로 섭니다.<br>
