...
<!--
  매출 그래프(월별) — 출고장별 / 월별 매출액 (2026-07-25 사용자 요청)
    ...
    · ★매입액·순마진 추가 (2026-07-26 요청) — 매입액도 마감(selectClosing)과 같은 규칙이다 :
        출고수량 × 매입단가(INPRICE_HST 중 발주일자 이전 최신, 없으면 상품마스터 IN_PRICE).
...
<div class="sc-wrap">
  ...
  <div class="sc-card" id="scHelpBox" style="display:none; border-color:#9fcfc5; background:#f6fbfa">
    ...
    <div class="sc-note">
      ...
      <b>매입액(원가)</b> = 나간 수량 × 매입단가 (매입가 이력 중 <b>발주일자 이전 최신</b> → 없으면 상품마스터 매입가)<br>
      ...
      <b>납품일자(=발주일자)</b> 기준입니다. 매출내역·마감과 같은 기준이라 월 경계에서 어긋나지 않습니다.
